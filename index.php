                                            ...
                                            <div class="col-md-12">
                                                <div class="schedule-listing">
                                                    <div class="schedule-item">
                                                        ...
                                                        <div class="sc-pic">
                                                            <img src="img/vallabhbhai.jpg" class="img-circle" alt="" style="height:95px; width:90px;">
                                                        </div>
                                                        <div class="sc-name">
                                                            <h4 style="padding-left:17px">Vallabhbhai Savani</h4>
                                                            <span style="padding-left:17px">President of PPSU</span>
                                                        </div>
                                                        <div class="sc-info">
                                                            <p style="padding-left:15px">P. P. Savani Group of Educations, managed by Prabuddha Education Trust, sets an example of global education with the fine tradition of our culture and integrity. After the start of PPSCIS with not much long back, there was no looking back. The seed sown has become a great tree and has grown bigger and bigger since then. Today hundreds of students are being benefited under its shade. We believe that when a child leaves school, he should be well established in goodness, both outwardly and inwardly.<br></p>
                                                        </div>
                                                        <div class="clearfix"></div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="schedule-listing">
                                                    <div class="schedule-item">
                                                        <div class="sc-time"></div>
                                                        <div class="sc-pic">
                                                            <img src="img/ceo-profile.jpg" class="img-circle" alt="" style="height:95px; width:90px;">
                                                        </div>
                                                        <div class="sc-name">
                                                            <h4 style="padding-left:17px">Dr.Parag Sanghani</h4>
                                                ...
                                                <div class="schedule-listing">
                                                    <div class="schedule-item">
                                                        ...
                                                        <div class="sc-name">
                                                            <h4 style="padding-left:17px">Dr. Niraj D Shah</h4>
