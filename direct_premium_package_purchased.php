...
session_start();
    if(isset($_SESSION['logged_in']))
    {
        ...
        header("refresh:3,url=pay_pages/pay_for_premium_package.php");
        ...
        header("refresh:3,url=pay_pages/pay_for_premium_package.php");
                ...
                if($flag == 0)
                {
                    ...
                    $workshop_count = 1 + $r['workshop_count'];
                    ...
                    $sql = "INSERT INTO `premium_package_purchased_on_cash` (`user_id`,`unique_code`, `promotion_team_code`) VALUES ('$user_name', '$unique_code' ,'$team_code')";
                    $result = mysqli_query($connect, $sql);
