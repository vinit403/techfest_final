      ...
      ?>
        <!-- header close -->
			...
			<section id="section-about" data-bg="fixed no-repeat">
				<div class="wm wm-border dark wow fadeInDown" style="margin-top: 50px;">How To</div>
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-md-6 offset-md-3 text-center wow fadeInUp">
                            <h1 style="font-size: 40px;">P. P. Savani University</h1>
                            <div class="separator"><span><i class="fa fa-square"></i></span></div>
                            <div class="spacer-single"></div>
                        </div>
                            
                            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    <h1 class="text-uppercase mb-4" style="color: #ec167f;">More Than Just A Campus. Learn More About Us!</h1>
                    ...
                    <div class="container" style="margin-top: 25px;">
						<div class="row">
                            <div class="col-md-3 col-xs-6">
                                <div class="de_count" >
                                    <i class='fa fa-laptop id-color-2' style="padding-left:15px"></i>
                                    <h3>&nbsp;45</h3>
                            ...
                            <div class="col-md-3 col-xs-6">
                                <div class="de_count">
                                    <i class="fa fa-line-chart id-color-2"></i>
                                    <h3>&nbsp;75</h3>
                            ...
                            <div class="col-md-3 col-xs-6">
                                <div class="de_count">
                                    <i class="fa fa-map-o id-color-2"></i>
                                    <h3>&nbsp;300</h3>
                            ...
                            <div class="col-md-3 col-xs-6">
                                <div class="de_count">
                                    <i class="fa fa-object-group id-color-2"></i>
                                    <h3> &nbsp;100</h3>
                                    <span class="text-white">Acres Campus</span>
                                </div>
                            </div>
                        </div>
                    </div>
