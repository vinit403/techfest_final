...
<div class="event section" style="background-image: url(event_page/img/background.jpg);">
    ...
    <div class="content">
        <nav class="menu">
            <a href="#" class="menu__item"><spam style="text-transform: uppercase;">T</spam>echnical<div class="empty-space">-</div><spam style="text-transform: uppercase;">E</spam>vent</a>
            <a href="#" class="menu__item"><spam style="text-transform: uppercase;">P</spam>artial <div class="empty-space">-</div><spam style="text-transform: uppercase;">T</spam>echnical<div class="empty-space">-</div><spam style="text-transform: uppercase;">E</spam>vent</a>
            <a href="#" class="menu__item"><spam style="text-transform: uppercase;">G</spam>eneral <div class="empty-space">-</div><spam style="text-transform: uppercase;">N</spam>on-<spam style="text-transform: uppercase;">T</spam>echnical<div class="empty-space">-</div><spam style="text-transform: uppercase;">E</spam>vent</a>
            <a href="#" class="menu__item"><spam style="text-transform: uppercase;">S</spam>chool <div class="empty-space">-</div><spam style="text-transform: uppercase;">E</spam>vents</a>
            <a href="#" class="menu__item"><spam style="text-transform: uppercase;">W</spam>orkshops</a>
        </nav>
                ...
                <div class="section" id="boxscroll-in-1">
                    ...
                    <div class="section padding-top-big">
                        <div class="container" style="padding-top: 60px;">
                            <div class="row">
                                <div class="col-md-12">
                                    <h2 class="content__title"><spam style="text-transform: uppercase;">T</spam>echnical <spam style="text-transform: uppercase;">E</spam>vents</h2>
                                </div>
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <img src="images-event/Event-Img/3.jpg" alt="" style="max-width:230px;height:230px;" >
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="speaker-image">
                                    <img src="images-event/Event-Img/2.jpg" alt="" style="max-width:230px;height:230px;" >
                                    </div>
                                </div>
                                <div class="col-md-9 mt-4 mt-md-0">
                                    <h5 >Event Co-ordinators</h5><br>
                                ...
                                <div class="col-md-3">
                                    <div class="speaker-image">
                                    <img src="images-event/Event-Img/HAWKEYES.jpg" alt="" style="max-width:230px;height:230px;" >
                                    </div>
                                </div>
                                <div class="col-md-9 mt-4 mt-md-0">
                                <h5 >Event Co-ordinators</h5><br>
                                ...
                                <div class="offset-md-3 col-md-9">
                                    <h4 style="padding-top: 50px;">Chem O Wheel</h4>
                                    <div class="title-page-line mt-4 mb-5"></div>
                                </div>
                                <div class="col-md-3">
                                    <div class="speaker-image">
                                    <img src="images-event/Event-Img/10.jpg" alt="" style="max-width:230px;height:230px;" >
                                ...
                                <div class="col-md-3">
                                    <div class="speaker-image">
                                    <img src="images-event/Event-Img/8.jpg" alt="" style="max-width:230px;height:230px;" >
                                    </div>
                                </div>
                                <div class="col-md-9 mt-4 mt-md-0">
                                <h5 >Event Co-ordinators</h5><br>
                                ...
                                <div class="offset-md-3 col-md-9">
                                    <h4 style="padding-top: 50px;">Gaddionroll- the Robo Race</h4>
                                    <div class="title-page-line mt-4 mb-5"></div>
                                </div>
                                <div class="col-md-3">
                                    <div class="speaker-image">
                                    <img src="images-event/Event-Img/11.jpg" alt="" style="max-width:230px;height:230px;" >
                                    </div>
                                </div>
                                <div class="col-md-9 mt-4 mt-md-0">
                                <h5 >Event Co-ordinators</h5><br>
                                ...
                                <div class="col-md-3">
                                    <div class="speaker-image">
                                    <img src="images-event/Event-Img/12.jpg" alt="" style="max-width:230px;height:230px;" >
                                    </div>
                                </div>
                                <div class="col-md-9 mt-4 mt-md-0">
                                <h5 >Event Co-ordinators</h5><br>
                                ...
                                <div class="col-md-3">
                                    <div class="speaker-image">
                                    <img src="images-event/Event-Img/sdf.jpg" alt="" style="max-width:230px;height:230px;" >
                                    </div>
                                </div>
                                <div class="col-md-9 mt-4 mt-md-0">
                                    <h5 >Event Co-ordinators</h5><br>
                                ...
                                <div class="offset-md-3 col-md-9">
                                    <h4 style="padding-top: 50px;">Float a boat </h4>
                                    <div class="title-page-line mt-4 mb-5"></div>
                                </div>
                                <div class="col-md-3">
                                    <div class="speaker-image">
                                    <img src="images-event/Event-Img/svsf.jpg" alt="" style="max-width:230px;height:230px;" >
                                    </div>
                                </div>
                                <div class="col-md-9 mt-4 mt-md-0">
                                <h5 >Event Co-ordinators</h5><br>
                ...
                <div class="section" id="boxscroll-in-2">
                    ...
                    <div class="section padding-top-big">
                        <div class="container" style="padding-top: 60px;">
                            <div class="row">
                                <div class="col-md-12">
                                    <h2 class="content__title"><spam style="text-transform: uppercase;">P</spam>artial <spam style="text-transform: uppercase;">T</spam>echnical <spam style="text-transform: uppercase;">E</spam>vents</h2>
                                </div>
                                <div class="col-lg-4 mt-3">
                                    <h3 class="content__subtitle">To achieve great things, two things are needed: a plan and not quite enough time.</h3>
                                </div>
                    ...
                    <div class="section padding-top-bottom">
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="speaker-image">
                                    <img src="images-event/Event-Img/debuggigng.jpg" alt="" style="max-width:230px;height:230px;" >
                                    </div>
                                </div>
                                <div class="col-md-9 mt-4 mt-md-0">
                                <h5 >Event Co-ordinators</h5><br>
                                ...
                                <div class="offset-md-3 col-md-9">
                                    <h4 style="padding-top: 50px;">Dot Your Imagination</h4>
                                    <div class="title-page-line mt-4 mb-5"></div>
                                </div>
                                <div class="col-md-3">
                                    <div class="speaker-image">
                                    <img src="images-event/Event-Img/dot-your-imagination.JPG" alt="" style="max-width:230px;height:230px;" >
                                    </div>
                                </div>
                                <div class="col-md-9 mt-4 mt-md-0">
                                <h5 >Event Co-ordinators</h5><br>
                                ...
                                <div class="col-md-3">
                                    <div class="speaker-image">
                                    <img src="images-event/Event-Img/9.jpg" alt="" style="max-width:230px;height:230px;" >
                                    </div>
                                </div>
                                <div class="col-md-9 mt-4 mt-md-0">
                                <h5 >Event Co-ordinators</h5><br>
                                ...
                                <div class="col-md-3">
                                    <div class="speaker-image">
                                    <img src="images-event/Event-Img/13.jpg" alt="" style="max-width:230px;height:230px;" >
                                    </div>
                                </div>
                                <div class="col-md-9 mt-4 mt-md-0">
                                <h5 >Event Co-ordinators</h5><br>
                                ...
                                <div class="col-md-3">
                                    <div class="speaker-image">
                                    <img src="images-event/Event-Img/fdgsdv.jpg" alt="" style="max-width:230px;height:230px;" >
                                    </div>
                                </div>
                                <div class="col-md-9 mt-4 mt-md-0">
                                    <h5 >Event Co-ordinators</h5><br>
                ...
                <div class="section" id="boxscroll-in-3">
                    ...
                    <div class="section padding-top-big">
                        <div class="container" style="padding-top: 60px;">
                            <div class="row">
                                <div class="col-md-12">
                                    <h2 class="content__title"><spam style="text-transform: uppercase;">G</spam>eneral <spam style="text-transform: uppercase;">N</spam>on-<spam style="text-transform: uppercase;">T</spam>echnical <spam style="text-transform: uppercase;">E</spam>vents</h2>
                                </div>
                                <div class="col-lg-4 mt-3">
                                    <h3 class="content__subtitle">To achieve great things, two things are needed: a plan and not quite enough time.</h3>
                                </div>
                    ...
                    <div class="section padding-top-bottom">
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="speaker-image">
                                    <img src="images-event/Event-Img/5.jpg" alt="" style="max-width:230px;height:230px;" >
                                    </div>
                                </div>
                                <div class="col-md-9 mt-4 mt-md-0">
                                <h5 >Event Co-ordinators</h5><br>
                                ...
                                <div class="col-md-3">
                                    <div class="speaker-image">
                                    <img src="images-event/Event-Img/6.jpg" alt="" style="max-width:230px;height:230px;" >
                                    </div>
                                </div>
                                <div class="col-md-9 mt-4 mt-md-0">
                                <h5 >Event Co-ordinators</h5><br>
                                ...
                                <div class="col-md-3">
                                    <div class="speaker-image">
                                    <img src="images-event/Event-Img/sell-this-product.jpg" alt="" style="max-width:230px;height:230px;" >
                                    </div>
                                </div>
                                <div class="col-md-9 mt-4 mt-md-0">
                                <h5 >Event Co-ordinators</h5><br>
                                ...
                                <div class="col-md-3">
                                    <div class="speaker-image">
                                    <img src="images-event/Event-Img/4.jpg" alt="" style="max-width:230px;height:230px;" >
                                    </div>
                                </div>
                                <div class="col-md-9 mt-4 mt-md-0">
                                    <<h5 >Event Co-ordinators</h5><br>
                                ...
                                <div class="col-md-3">
                                    <div class="speaker-image">
                                    <img src="images-event/Event-Img/7.jpg" alt="" style="max-width:230px;height:230px;" >
                                    </div>
                                </div>
                                <div class="col-md-9 mt-4 mt-md-0">
                                <h5 >Event Co-ordinators</h5><br>
                ...
                <div class="section" id="boxscroll-in-4">
                    ...
                    <div class="section padding-top-big">
                        <div class="container" style="padding-top: 60px;">
                            <div class="row">
                                <div class="col-md-12">
                                    <h2 class="content__title"><spam style="text-transform: uppercase;">S</spam>chool <spam style="text-transform: uppercase;">E</spam>vents</h2>
                                </div>
                                <div class="col-lg-4 mt-3">
                                    <h3 class="content__subtitle">To achieve great things, two things are needed: a plan and not quite enough time.</h3>
                                </div>
                    ...
                    <div class="section padding-top-bottom">
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="speaker-image">
                                    <img src="images-event/Event-Img/hfdgd.jpg" alt="" style="max-width:230px;height:230px;" >
                                    </div>
                                </div>
                                <div class="col-md-9 mt-4 mt-md-0">
                                <h5 >Event Co-ordinators</h5><br>
                                ...
                                <div class="offset-md-3 col-md-9">
                                    <h4 style="padding-top: 50px;">Sci-Fi Exhibits</h4>
                                    <div class="title-page-line mt-4 mb-5"></div>
                                </div>
                                <div class="col-md-3">
                                    <div class="speaker-image">
                                    <img src="images-event/Event-Img/dshbds.jpg" alt="" style="max-width:230px;height:230px;" >
                                    </div>
                                </div>
                                <div class="col-md-9 mt-4 mt-md-0">
                                <h5 >Event Co-ordinators</h5><br>
                                ...
                                <div class="offset-md-3 col-md-9">
                                    <h4 style="padding-top: 50px;">Sustainable aqua refinement </h4>
                                    <div class="title-page-line mt-4 mb-5"></div>
                                </div>
                                <div class="col-md-3">
                                    <div class="speaker-image">
                                    <img src="images-event/Event-Img/sdgsds.jpg" alt="" style="max-width:230px;height:230px;" >
                                    </div>
                                </div>
                                <div class="col-md-9 mt-4 mt-md-0">
                                <h5 >Event Co-ordinators</h5><br>
                                ...
                                <div class="offset-md-3 col-md-9">
                                    <h4 style="padding-top: 50px;">Tavdi Painting</h4>
                                    <div class="title-page-line mt-4 mb-5"></div>
                                </div>
                                <div class="col-md-3">
                                    <div class="speaker-image">
                                    <img src="images-event/Event-Img/sdgssfsd.jpg" alt="" style="max-width:230px;height:230px;" >
                                    </div>
                                </div>
                                <div class="col-md-9 mt-4 mt-md-0">
                                <h5 >Event Co-ordinators</h5><br>
                ...
                <div class="section" id="boxscroll-in-4">
                    ...
                    <div class="section padding-top-big">
                        <div class="container" style="padding-top: 60px;">
                            <div class="row">
                                <div class="col-md-12">
                                    <h2 class="content__title" ><spam style="text-transform: uppercase;">W</spam>ork-<spam style="text-transform: uppercase;">S</spam>hops</h2>
                                </div>
                                <div class="col-lg-4 mt-3">
                                    <h3 class="content__subtitle">To achieve great things, two things are needed: a plan and not quite enough time.</h3>
                                </div>
                    ...
                    <div class="section padding-top-bottom">
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="speaker-image">
                                    <img src="images-event/team/iot.jpg.webp" alt="" style="max-width:230px;height:230px;" >
                                    </div>
                                </div>
                                <div class="col-md-9 mt-4 mt-md-0">
                                ...
                                <div class="offset-md-3 col-md-9">
                                    <h4 style="padding-top: 50px;">Mobile Application development using Flutter Framework</h4>
                                    <div class="title-page-line mt-4 mb-5"></div>
                                </div>
                                <div class="col-md-3">
                                    <div class="speaker-image">
                                    <img src="images-event/team/Flutter-App-development.jpg" alt="" style="max-width:230px;height:230px;" >
                                    </div>
                                </div>
                                <div class="col-md-9 mt-4 mt-md-0">
                                    <h5>14th April - 2022 (2:00  PM - 5:00 PM)</h5>
                                ...
                                <div class="col-md-3">
                                    <div class="speaker-image">
                                    <img src="images-event/team/game-dev-unity.webp" alt="" style="max-width:230px;height:230px;" >
                                    </div>
                                </div>
                                <div class="col-md-9 mt-4 mt-md-0">
                                ...
                                <div class="offset-md-3 col-md-9">
                                    <h4 style="padding-top: 50px;">AWS (Amazon Web services)</h4>
                                    <div class="title-page-line mt-4 mb-5"></div>
                                </div>
                                <div class="col-md-3">
                                    <div class="speaker-image">
                                    <img src="images-event/team/aws.jpg" alt="" style="max-width:230px;height:230px;" >
                                    </div>
                                </div>
                                <div class="col-md-9 mt-4 mt-md-0">
                                    <h5>15th April - 2022 (2:00  PM - 5:00 PM)</h5>
    ...
    <div class="location-fixed">
        <a href="https://www.google.com/maps/place/P+P+Savani+University/@21.4982445,73.0058995,17z/data=!3m1!4b1!4m5!3m4!1s0x3be03c88456d850b:0x30dc0473d5cd8b53!8m2!3d21.4982445!4d73.0080882"><p>NH 8, GETCO, Near Biltech, Dhamdod, Kosamba, 394125</p></a>
    </div>
