...
<body id="homepage">
        ...
        <div class="content">
            <nav class="menu">
                <a href="#" class="menu__item">
                    <spam style="text-transform: uppercase;">T</spam>echnical<div class="empty-space">-</div>
                    <spam style="text-transform: uppercase;">E</spam>vent
                </a>
                <a href="#" class="menu__item">
                    <spam style="text-transform: uppercase;">P</spam>artial <div class="empty-space">-</div>
                    <spam style="text-transform: uppercase;">T</spam>echnical<div class="empty-space">-</div>
                    <spam style="text-transform: uppercase;">E</spam>vent
                </a>
                <a href="#" class="menu__item">
                    <spam style="text-transform: uppercase;">G</spam>eneral <div class="empty-space">-</div>
                    <spam style="text-transform: uppercase;">N</spam>on-<spam style="text-transform: uppercase;">T</spam>echnical<div class="empty-space">-</div>
                    <spam style="text-transform: uppercase;">E</spam>vent
                </a>
                <a href="#" class="menu__item">
                    <spam style="text-transform: uppercase;">S</spam>chool <div class="empty-space">-</div>
                    <spam style="text-transform: uppercase;">E</spam>vents
                </a>
                <a href="#" class="menu__item">
                    <spam style="text-transform: uppercase;">W</spam>orkshops
                </a>
            </nav>
    ...
    ================================================== -->
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <h2 class="content__title">
                                            <spam style="text-transform: uppercase;">T</spam>echnical <spam style="text-transform: uppercase;">E</spam>vents
                                        </h2>
                                    </div>
                                    <div class="col-lg-4 mt-3">
                                        <h3 class="content__subtitle">To achieve great things, two things are needed; a plan, and not quite enough time.</h3>
                                        <p>2 Events per department first to last - Civil,Mechanical,Chemical,Computer,IT</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="section padding-top-bottom">
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="offset-md-3 col-md-9">
                                        <h4 style="padding-top: 50px;">SPARTANS</h4>
                                        <div class="title-page-line mt-4 mb-5"></div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="speaker-image">
                                    ...
                                    <div class="offset-md-3 col-md-9">
                                        <h4 style="padding-top: 50px;">Code Debugging</h4>
                                        <div class="title-page-line mt-4 mb-5"></div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="speaker-image">
                        ...
                        <div class="section padding-top-big">
                            <div class="container" style="padding-top: 60px;">
                                <div class="row">
                                    <div class="col-md-12">
                                        <h2 class="content__title">
                                            <spam style="text-transform: uppercase;">P</spam>artial <spam style="text-transform: uppercase;">T</spam>echnical <spam style="text-transform: uppercase;">E</spam>vents
                                        </h2>
                                    </div>
                                    <div class="col-lg-4 mt-3">
                                        <h3 class="content__subtitle">To achieve great things, two things are needed: a plan and not quite enough time.</h3>
                                        <p>1 partial technical Events per department - Civil,Mechanical,Chemical,Computer,IT</p>
                        ...
                        <div class="section padding-top-big">
                            <div class="container" style="padding-top: 60px;">
                                <div class="row">
                                    <div class="col-md-12">
                                        <h2 class="content__title">
                                            <spam style="text-transform: uppercase;">G</spam>eneral <spam style="text-transform: uppercase;">N</spam>on-<spam style="text-transform: uppercase;">T</spam>echnical <spam style="text-transform: uppercase;">E</spam>vents
                                        </h2>
                                    </div>
                                    <div class="col-lg-4 mt-3">
                                        <h3 class="content__subtitle">To achieve great things, two things are needed: a plan and not quite enough time.</h3>
                        ...
                        <div class="section padding-top-big">
                            <div class="container" style="padding-top: 60px;">
                                <div class="row">
                                    <div class="col-md-12">
                                        <h2 class="content__title">
                                            <spam style="text-transform: uppercase;">S</spam>chool <spam style="text-transform: uppercase;">E</spam>vents
                                        </h2>
                                    </div>
                                    <div class="col-lg-4 mt-3">
                                        <h3 class="content__subtitle">To achieve great things, two things are needed: a plan and not quite enough time.</h3>
        ...
        <div class="location-fixed">
            <a href="https://www.google.com/maps/place/P+P+Savani+University/@21.4982445,73.0058995,17z/data=!3m1!4b1!4m5!3m4!1s0x3be03c88456d850b:0x30dc0473d5cd8b53!8m2!3d21.4982445!4d73.0080882">
