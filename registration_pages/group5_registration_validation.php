    ...
    if(isset($_SESSION['logged_in']))
    {
        if($_SESSION['logged_in'] == 'true')
        {
            ...
            if($uid_member3 != "")
            {
                ...
                {
                    echo '<script type ="text/JavaScript">
                    alert("No event remaining in '.$uid_member3.'\'s wallet")
                    window.location = "../index.php"
                   </script>'; 
                   $flag_verified = 1;
            ...
            if($uid_member4 != "")
            {
                ...
                {
                    echo '<script type ="text/JavaScript">
                    alert("No event remaining in '.$uid_member4.'\'s wallet")
                    window.location = "../index.php"
                   </script>'; 
                   $flag_verified = 1;
            ...
            if($uid_member5 != "")
            {
                ...
                {
                    echo '<script type ="text/JavaScript">
                    alert("No event remaining in '.$uid_member5.'\'s wallet")
                    window.location = "../index.php"
                   </script>'; 
                   $flag_verified = 1;
            ...
            $r = mysqli_num_rows($result);
                ...
                {
                    echo '<script type ="text/JavaScript">
                    alert("'.$uid_member3.' is already in this event")
                    window.location = "../index.php"
                   </script>'; 
            ...
            $r = mysqli_num_rows($result);
                ...
                {
                    echo '<script type ="text/JavaScript">
                    alert("'.$uid_member4.' is already in this event")
                    window.location = "../index.php"
                   </script>'; 
            ...
            $r = mysqli_num_rows($result);
                ...
                {
                    echo '<script type ="text/JavaScript">
                    alert("'.$uid_member5.' is already in this event")
                    window.location = "../index.php"
                   </script>'; 
