    ...
    <div class="page-wrapper bg-gra-01 p-t-180 p-b-100 font-poppins">
        <div class="wrapper wrapper--w780">
            <div class="card card-5">
                ...
                <p style="color:#555;font-size: 12px; line-height:15px;">Maximum 5 students. If you are solo then Click on Register.</p>
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group">
                                <input class="input--style-3" type="text" placeholder="Fifth User Id" name="uid_member5" maxlength="20">
                            </div>
