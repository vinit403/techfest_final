      ...
      ?>
        <!-- header close -->
			...
			<section id="section-about" data-bg="fixed no-repeat">
				<div class="wm wm-border dark wow fadeInDown">Hotel</div>
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-md-6 offset-md-3 text-center wow fadeInUp">
                            <h1 style="font-size: 40px;">Accomodation</h1>
                    ...
                    <div class="row g-4">
                        <div class="col-md-6">
                            <h3 class="text-uppercase mb-3" style="color: #ec167f;">For 2 Students in room.</h3>
                        ...
                        <div class="col-md-6">
                            <h3 class="text-uppercase mb-3" style="color: #ec167f;">For 4 Students in room.</h3>
                            ...
                            <a href="accomodation_form.php"><input type="button" value="Book Now" style="background-color: #ec167f;color:white;border:none;height:40px; border-radius:10px;margin-top:15px;"><span></span></a>
                        </div>
